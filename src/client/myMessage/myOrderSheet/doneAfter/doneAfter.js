...
class DoneAfter extends Component{
	constructor(props){
	    super(props);
		this.state = {
			focused: false,
    ...
    return (
      <div className='content' style={{height:h}}>
		 ...
		 <InputItem
            ...
            disabled
          >快递单号</InputItem>
          <Button className="btn" type="primary" onClick={this.handleClick} >退货</Button>
      </div>
    );
  }
}
DoneAfter = createForm()(DoneAfter);
module.exports = DoneAfter;
